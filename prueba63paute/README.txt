...
a persistence unit "prueba63pautePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba63paute/pom.xml":
...
artifact ("prueba63paute.war") is already built. You can build
