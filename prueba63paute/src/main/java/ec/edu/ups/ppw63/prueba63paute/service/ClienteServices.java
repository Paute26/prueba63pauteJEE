package ec.edu.ups.ppw63.prueba63paute.service;

import java.util.List;

import ec.edu.ups.ppw63.prueba63paute.business.GestionClientes;
...
public class ClienteServices {
	...
	@Produces(MediaType.APPLICATION_JSON)
	//@Produces("application/json")
	public Response leer2(@PathParam("ci") String cedula, @PathParam("nombre") String nombre) {
		try{
			System.out.println("cedula " +  cedula + " nom=" + nombre);
			Cliente cli = gClientes.getClientePorCedula(cedula);
			return Response.ok(cli).build();
